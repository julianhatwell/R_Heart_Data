...
```{r km_diag}
cm <- confusionMatrix(factor(km2_clus$cluster, labels = c("Yes", "No")), heart$HDisease)
cm
fviz_cluster(km2_clus, heart_real
             , ellipse.type = "convex"
             , geom = "point"
             , ggtheme = theme_bw()
...
```{r km_diag2}
km2_clus$withinss / km2_clus$totss
km2_clus$withinss / km2_clus$tot.withinss
km2_clus$betweenss / km2_clus$totss
```
...
We can see from these results that the cluster id is the reverse of the previous method. It doesn't matter because the cluster id is completely arbitrary as this is unsupervised learning. Again we have a good alignment with the ground truth. Knowing the id that has associated with HDisease = Yes, it is easy to provide the appropriate labelling the the confusion matrix.
